...
exports.MESSAGE_FILTER_PATTERNS = exports.USERNAME_FILTER_PATTERNS = exports.MESSAGE_BAD_WORDS = exports.USERNAME_UNSAFE_WORDS = void 0;
// List of unsafe words to block in usernames (strict list)
exports.USERNAME_UNSAFE_WORDS = [
    // Administrative terms
    'admin', 'administrator', 'moderator', 'mod', 'system', 'server', 'root', 'superuser',
    // Racial slurs (partial list - censored/abbreviated)
    'n-word', 'nigger', 'negro', 'chink', 'spic', 'kike', 'wetback', 'gook', 'coon',
    // Offensive terms
    'nazi', 'hitler', 'fascist', 'racist', 'sexist', 'homophobe', 'transphobe',
    // Vulgar/offensive terms
    'fuck', 'shit', 'bitch', 'cunt', 'asshole', 'dick', 'pussy', 'whore',
    // Hate speech indicators
    'kill', 'murder', 'rape', 'terrorist', 'jihad', 'holocaust',
    // Impersonation terms
    'official', 'staff', 'support', 'helpdesk', 'service',
    // Other terms
    'fack', 'fvck', 'fuk', 'fucc', 'phuck', 'phuk', 'feck', 'fick',
    'sh1t', 'shet', 'shyt', 'biatch', 'b1tch', 'bytch', 'kunt', 'cnut',
];
// List of words to filter in messages (only offensive content)
exports.MESSAGE_BAD_WORDS = [
    // Racial slurs (partial list - censored/abbreviated)
    'n-word', 'nigger', 'negro', 'chink', 'spic', 'kike', 'wetback', 'gook', 'coon',
    // Offensive terms
    'nazi', 'hitler', 'fascist', 'racist', 'sexist', 'homophobe', 'transphobe',
    ...
    'kill', 'murder', 'rape', 'terrorist', 'jihad', 'holocaust',
    // French vulgar terms
    'putain', 'merde', 'connard', 'salope', 'enculé', 'con', 'pute', 'foutre', 'branler', 'niquer',
    // Spanish vulgar terms
    'puta', 'mierda', 'pendejo', 'cabrón', 'joder', 'coño', 'maricon', 'chinga', 'verga', 'culo',
    // German vulgar terms
    'scheiße', 'arschloch', 'fotze', 'hurensohn', 'schwuchtel', 'schwanz', 'ficken', 'wichser',
    // Italian vulgar terms
    'cazzo', 'stronzo', 'puttana', 'merda', 'figa', 'troia', 'vaffanculo', 'minchia',
    // Portuguese vulgar terms
    'porra', 'caralho', 'foda', 'puta', 'buceta', 'viado', 'merda', 'corno',
    // Russian vulgar terms (transliterated)
    'blyat', 'suka', 'pizda', 'khuy', 'yebat', 'mudak', 'pidor', 'zalupa'
];
// Regex patterns for advanced username filtering
exports.USERNAME_FILTER_PATTERNS = [
    // Admin variations (adm1n, @dmin, a_dmin, etc.)
    [/[aáàäâ@4]+[\s_\-\.]*[dḍḏ]+[\s_\-\.]*[mḿṁ]+[\s_\-\.]*[iíìïî1!|]+[\s_\-\.]*[nñń]+/gi, 'admin'],
    [/a[\W_]*d[\W_]*m[\W_]*i[\W_]*n/gi, 'admin'],
    // Mod/Moderator variations
    [/[mḿṁ]+[\s_\-\.]*[oóòöô0ø€]+[\s_\-\.]*[dḍḏ]+/gi, 'mod'],
    [/m[\W_]*o[\W_]*d/gi, 'mod'],
    [/[mḿṁ]+[\s_\-\.]*[oóòöô0ø€]+[\s_\-\.]*[dḍḏ]+[\s_\-\.]*[eéèëê3]+[\s_\-\.]*[rŕṙ]+[\s_\-\.]*[aáàäâ@4]+[\s_\-\.]*[tṫ]+[\s_\-\.]*[oóòöô0ø€]+[\s_\-\.]*[rŕṙ]+/gi, 'moderator'],
    [/m[\W_]*o[\W_]*d[\W_]*e[\W_]*r[\W_]*a[\W_]*t[\W_]*o[\W_]*r/gi, 'moderator'],
    // System variations (sy5tem, s-ystem, etc.)
    [/[sšśṡ5$]+[\s_\-\.]*[yýÿ]+[\s_\-\.]*[sšśṡ5$]+[\s_\-\.]*[tṫ]+[\s_\-\.]*[eéèëê3€]+[\s_\-\.]*[mḿṁ]+/gi, 'system'],
    ...
    [/[sšśṡ5$]+[\s_\-\.]*[eéèëê3€]+[\s_\-\.]*[rŕṙ]+[\s_\-\.]*[vṽ]+[\s_\-\.]*[eéèëê3€]+[\s_\-\.]*[rŕṙ]+/gi, 'server'],
...
exports.MESSAGE_FILTER_PATTERNS = [
    ...
    [/f[^a-zA-Z0-9]*[uüùûúūvw4\*\^@][^a-zA-Z0-9]*[cҫçćč¢kq][^a-zA-Z0-9]*k/gi, 'f***'],
    ...
    [/[rŕṙ]+[\s_\-\.]*[aáàäâ@4]+[\s_\-\.]*[cćç]+[\s_\-\.]*[iíìïî1!|]+[\s_\-\.]*[sšśṡ5$]+[\s_\-\.]*[tṫ]+/gi, 'racist'],
    ...
    // Slur variations
    [/[nñń]+[\s_\-\.]*[iíìïî1!|]+[\s_\-\.]*[gǵ]+[\s_\-\.]*[gǵ]+[\s_\-\.]*[eéèëê3€]+[\s_\-\.]*[rŕṙ]+/gi, 'n*****'],
    ...
    [/f[^\s\w]*?(?:u|ü|v|\*|ú|ù|û|µ|\^|\$|%|\+|\d)[^\s\w]*?c[^\s\w]*?k/gi, 'f***'],
    ...
    [/a[\W_]*[s5\$]+[\W_]*[s5\$]+[\W_]*h[\W_]*[o0öôòó@]+[\W_]*l[\W_]*[e3€]+/gi, 'a******'],
    // French vulgar terms
    ...
    [/v[\W_]*a[\W_]*f[\W_]*f[\W_]*a[\W_]*n[\W_]*c[\W_]*u[\W_]*l[\W_]*o/gi, 'v*********o'],
    // Portuguese vulgar terms
